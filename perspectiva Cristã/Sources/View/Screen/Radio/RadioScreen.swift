...
class RadioScreen: BaseView {
    ...
    override func setupConstrainst() {
        NSLayoutConstraint.activate([
            ...
            radioImage.topAnchor.constraint(equalTo: subTitleLabel.bottomAnchor,constant: 50),
            ...
            playButton.topAnchor.constraint(equalTo: radioImage.bottomAnchor, constant: 130),
            playButton.centerXAnchor.constraint(equalTo: centerXAnchor),
            
            pauseButton.topAnchor.constraint(equalTo: radioImage.bottomAnchor, constant: 130),
